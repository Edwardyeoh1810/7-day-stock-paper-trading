...
The improvement loop of the experiment. See `03-定时任务-routines/REVIEW-PROMPT.md` for the rules.

- `stats.json` — written by `06-程序脚本-scripts/review_stats.py`; never edit by hand.
- `YYYY-MM-DD.md` — one daily review per local day.
