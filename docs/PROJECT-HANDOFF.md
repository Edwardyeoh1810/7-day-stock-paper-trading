...
Evidence: [API result](../data/evidence/manual_20260914T153531531996.json), [journal](../data/journal/manual_20260914T153531531996.md), [readiness](../state/readiness.json). The error does not distinguish an invalid key from an IP or permission problem.
