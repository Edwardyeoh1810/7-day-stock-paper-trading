...
| Validation | [Validation record](../05-交易记录-data/evidence/2026-09-14-validation.md) |
...
Real credentials stay only in `09-API密钥-仅本地/binance-api.env`. Share `09-API密钥-仅本地/binance-api.env.example`, not the completed file, editor swap files or backups. Git ignore rules do not filter Finder copies or archives.
